...
/* 
    VARIÁVEIS - Existem quatro formas de declararmos variáveis em JS, não reinicialize variáveis
...
/*
    Constantes são variáveis que não mudam, seguindo as mesmas regras de nomeação que variáveis comuns, não se pode modificar uma constante e 
    é necessário sempre inicializá-la com algum valor
*/
const NOME = "Jaques Hyago";

//TIPOS DE DADOS

/*o JS inevitavelmente inicializará essa variável, por mais que a mesma não tenha sido inicializada pelo desenvolvedor, ele atribuirá o valor Undefined para ela
Um valor que não aponta para lugar nenhum na memória */
...
/*
    <condicao> ? <verdadeiro> : <falso>; resultado receberá o retorno da operação ternária. É um operador que não permite grande lógica em seus resultados, apenas dados mais brutos, como strings ou numbers. Parentêses são opcionais.
*/
